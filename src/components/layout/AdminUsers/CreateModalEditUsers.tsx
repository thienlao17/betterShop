...
import UserEditForm from '@/components/layout/AdminUsers/UserEditForm'

export default function CreateModalEditUsers({ userId }: { userId: number }) {
            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <UserEditForm closeDialog={onModalClose} userId={userId} />
                </Dialog.Panel>
              </Transition.Child>
            </div>
          </div>
